...
public class @InputControls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""CameraSwap"",
            ""id"": ""fe374aba-1d2a-49af-bb5b-34988b898e09"",
            ""actions"": [
                {
                    ""name"": ""sw"",
                    ""type"": ""Button"",
                    ""id"": ""28c4e113-a5cf-4759-bddc-7b369a901b8a"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""b20aa72f-bbd4-48b7-9ed6-ec65c6124548"",
                    ""path"": ""f5"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
    ...
    ""controlSchemes"": [
        ...
        m_CameraSwap_sw = m_CameraSwap.FindAction("sw", throwIfNotFound: true);
    }
    ...
    private ICameraSwapActions m_CameraSwapActionsCallbackInterface;
    private readonly InputAction m_CameraSwap_sw;
    public struct CameraSwapActions
    {
        private @InputControls m_Wrapper;
        public CameraSwapActions(@InputControls wrapper) { m_Wrapper = wrapper; }
        public InputAction @sw => m_Wrapper.m_CameraSwap_sw;
        ...
        {
            if (m_Wrapper.m_CameraSwapActionsCallbackInterface != null)
            {
                @sw.started -= m_Wrapper.m_CameraSwapActionsCallbackInterface.OnSw;
                @sw.performed -= m_Wrapper.m_CameraSwapActionsCallbackInterface.OnSw;
                @sw.canceled -= m_Wrapper.m_CameraSwapActionsCallbackInterface.OnSw;
            }
            m_Wrapper.m_CameraSwapActionsCallbackInterface = instance;
            if (instance != null)
            {
